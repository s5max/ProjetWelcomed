...
<!--						<?= $d['exercise']?><br>Nbre de praticiens : <?= $d['nbPraticioner']?><br>Logiciel utilisé : <?=$d['software']?></p>-->
					...
					<?php if(!isset($_SESSION['user'])){ ?>
							...
							<a id="contact" class="btn btn-lg btn-rounded btn-primary waves-effect waves-light btn-contact mod" data-receiver="<?=$v['user_id'];?>" data-toggle="modal" data-target="#modal4all" disabled>Contacter l'annonceur</a>

            ...
            <fieldset>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="lastname" value="<?=$userr['lastname']; ?>" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                            <input type="text" class="form-control" name="firstname" value="<?=$userr['firstname']; ?>" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                            <input type="text" class="form-control" name="profession" value="<?=$userr['profession']; ?>" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control" name="email" value="<?=$userr['email']; ?>" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="telephone" value="<?=$userr['telephone']; ?>" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="address" value="<?=$userr['address']; ?>" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-address-card" aria-hidden="true"></i></span>
                            <input type="text" class="form-control" name="zipcode" value="<?=$userr['zipcode']; ?>" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-address-card" aria-hidden="true"></i></span>
                            <input type="text" class="form-control" name="city" value="<?=$userr['city']; ?>" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="department" value="<?=$userr['department']; ?>" disabled>
                        </div>
                    </div>
                </div>
